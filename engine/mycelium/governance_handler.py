...
from engine.sentinel import SentinelEngine, KeyManager, canonical_json, verify_signature
...
class GovernanceHandler:
    ...
    def _update_escalation_map(self, change: Dict) -> Dict[str, Any]:
        ...
        try:
            from engine.neuraxis.escalation import ErrorClass, Layer, ESCALATION_MAP
            new_map = {}
    ...
    def _update_autonomous_layers(self, change: Dict) -> Dict[str, Any]:
        ...
        try:
            from engine.neuraxis.escalation import Layer, AUTONOMOUS_LAYERS
    ...
    def _update_governance_layers(self, change: Dict) -> Dict[str, Any]:
        ...
        try:
            from engine.neuraxis.escalation import Layer, GOVERNANCE_LAYERS
            new_layers = {Layer(l) for l in layers}
