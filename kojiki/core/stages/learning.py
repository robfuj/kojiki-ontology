...
import re
from kojiki.core import ScopedContext, call_model, validate_against_schema, StageName
...
async def finalize_causal_chain(runner, dispatch: Dict[str, Any]):
    ...
    # Save to specialist's causal_chains directory (3 parents up from stages/ -> kojiki/)
    specialist_dir = Path(__file__).parent.parent.parent / "specialists" / runner.specialist.name
