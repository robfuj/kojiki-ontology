"""
AI Intelligence Specialist (Technology Platform)
Coordinates AI, IT, Security, Data Analytics teams
"""
...
class AIIntelligenceSpecialist(Specialist):
    """Technology Platform Department Head - coordinates AI, IT, Security, Data Analytics teams."""
    ...
    def stages(self) -> dict:
        ...
        return {
            ...
            "outcome": StageConfig(
                ...
                schema=str(base / "schemas" / "outcome_kaizen.json"),
                tools=[],
            ...
            "learning": StageConfig(
                ...
                schema=str(base / "schemas" / "learning_kaizen.json"),
                tools=[],
...
if __name__ == "__main__":
    specialist = AIIntelligenceSpecialist()
