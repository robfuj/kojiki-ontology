...
Coordinates Outbound, Inbound, Enablement, Operations teams
"""
...
class SalesOutboundSpecialist(Specialist):
    """Sales Department Head - coordinates Outbound, Inbound, Enablement, Operations teams."""
...
if __name__ == "__main__":
    # Quick test
    specialist = SalesOutboundSpecialist()
