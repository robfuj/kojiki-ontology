...
Coordinates Platform, Referral, API, Infrastructure, Data teams
"""
...
class EngineeringPlatformSpecialist(Specialist):
    """Engineering Department Head - coordinates Platform, Referral, API, Infrastructure, Data teams."""
...
if __name__ == "__main__":
    specialist = EngineeringPlatformSpecialist()
