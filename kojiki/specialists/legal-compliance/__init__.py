...
Coordinates Contracts, Regulatory, Compliance, Audit, Controls, Risk teams
"""
...
class LegalComplianceSpecialist(Specialist):
    """Legal Department Head - coordinates Contracts, Regulatory, Compliance, Audit, Controls, Risk teams."""
...
if __name__ == "__main__":
    specialist = LegalComplianceSpecialist()
