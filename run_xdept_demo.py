...
record_verified = {
    "synapsis": {"conclusion": sv.get("strategy"), "transformations": [
        ...
        {"name": "EVIDENCE", "state_kind": "evidence", "output": mkt_obj.get("evidence"), "source_citation": "Kojiki source specification (marketing.EVIDENCE)", "consumes": [{"producer": "marketing.EVIDENCE", "state_provenance": "sibling-verified"}]},
...
record_standalone = {
    "synapsis": {"conclusion": sa.get("strategy"), "transformations": [
        ...
        {"name": "EVIDENCE", "state_kind": "evidence", "output": "Local market assumptions (no sibling evidence available).", "source_citation": "Kojiki source specification (self-generated, standalone mode)", "consumes": [{"producer": "marketing.EVIDENCE", "state_provenance": "self-generated"}]},
